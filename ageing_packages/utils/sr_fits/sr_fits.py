...
SR_FITS: Dict[str, Dict[str, Any]] = {
    ...
    "swe_period_2019_joint_shared_eta_beta_epsilon_60_100": _fit(
        ...
        source="notebooks/thresholds, noise/joint_shared_eta_beta_epsilon_60_100.py",
        country="SWE",
        gender="both",
        data_type="period",
        year=2019,
    ...
    "swe_period_2019_joint_tail90_65_100": _fit(
        ...
        source="notebooks/thresholds, noise/joint_shared_eta_beta_epsilon_65_100_n100k_tail90.py",
        country="SWE",
        gender="both",
        data_type="period",
        year=2019,
    ...
    "usa_period_2019_hybrid_swe_tail90_usa_refit_65_100": _fit(
        ...
        source="notebooks/thresholds, noise/joint_shared_eta_beta_epsilon_65_100_n100k_swe_tail90_usa_refit.py",
        country="USA",
        gender="both",
        data_type="period",
        year=2019,
    ...
    "swe_cohort_1900_fixed_eta_beta_age65_100": _fit(
        ...
        source="notebooks/thresholds, noise/fit_sweden_historical_fixed_eta_beta.py",
        country="SWE",
        gender="both",
        data_type="cohort",
        year=1900,
