...
nhanes_data_path = str(PROJECT_ROOT / "saved_data" / "nhanes") + os.sep
saved_results_path = str(PROJECT_ROOT / "saved_results") + os.sep
DEFAULT_SR_USA_2019_PKL = os.path.join(saved_results_path, 'param_variation_results_usa_2019.pkl')
DEFAULT_SR_USA_2019_UNDERLAY_CACHE = os.path.join(saved_results_path, 'sr_usa_2019_steepness_longevity_curves.pkl')
...
def load_interventions_dict(pickle_path=None):
    if pickle_path is None:
        pickle_path = os.path.join(saved_results_path, 'exposure_groups_results.pkl')
    try:
