...
CACHE_DIR = SAVED_RESULTS_DIR / "cache" / "simulations" / "artificial_survival_time"
EVENTS_CACHE_PATH = CACHE_DIR / "matched_sweden2019_event_times.npz"
METADATA_PATH = CACHE_DIR / "matched_sweden2019_metadata.json"
SUMMARY_PATH = SAVED_RESULTS_DIR / "csv" / "artificial_survival_time_summary.csv"
STATE_PATH = SAVED_RESULTS_DIR / "csv" / "artificial_survival_time_state_composition.csv"
INDEX_PATH = SAVED_RESULTS_DIR / "index" / "outputs.csv"
SUPP_OUTPUT_DIR = FIGURES_NEW_DIR / "Supp_Figgs"
