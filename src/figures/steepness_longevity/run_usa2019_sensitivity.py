#!/usr/bin/env python3
"""Run USA 2019 steepness-longevity sensitivity simulations.
...
OUTPUT_DIR = SAVED_RESULTS_DIR / "steepness_longevity_usa2019_sensitivity"
METRICS_PATH = OUTPUT_DIR / "metrics_long.csv"
SCENARIOS_PATH = OUTPUT_DIR / "baseline_scenarios.csv"
MANIFEST_PATH = OUTPUT_DIR / "manifest.json"
README_PATH = OUTPUT_DIR / "README.md"

RUN_LABEL = "usa2019_hybrid_zero_hext_sensitivity"
...
BASELINE = {
    ...
    "xc_std_frac": 0.1918528238650529,
}

PARAMS_TO_VARY = ("eta", "beta", "epsilon", "Xc")
...
def build_readme(manifest: dict[str, object]) -> str:
    return f"""# USA 2019 Steepness-Longevity Sensitivity Run
