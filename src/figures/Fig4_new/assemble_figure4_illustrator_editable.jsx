...
var outputDir = "/Users/benshenhar/Library/CloudStorage/GoogleDrive-benshenhar@gmail.com/My Drive/Weizmann/Alon Lab/Aging/python/notebooks/thresholds, noise/Figures_new/Fig4_new";
...
var aiFile = new File(outputDir + "/Figure4_new_editable.ai");
var aiOptions = new IllustratorSaveOptions();
aiOptions.pdfCompatible = true;
doc.saveAs(aiFile, aiOptions);

var pdfFile = new File(outputDir + "/Figure4_new_editable.pdf");
var pdfOptions = new PDFSaveOptions();
pdfOptions.preserveEditability = true;
doc.saveAs(pdfFile, pdfOptions);

var pngFile = new File(outputDir + "/Figure4_new_editable.png");
