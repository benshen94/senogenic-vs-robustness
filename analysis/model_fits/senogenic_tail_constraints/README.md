...
- Baseline: Sweden 2019 tail-emphasis fit from `results/fits/records/joint2019_tail90_sweden_emphasis.json`.
...
- Distribution source rows: `results/tables/senogenic_tail_distribution_scenarios.csv`.
- Truncation source rows: `results/tables/senogenic_tail_truncated_eta.csv`.
- Correlation source rows: `results/tables/senogenic_tail_correlated_eta_beta.csv`.
- Mixture bounds: `results/tables/senogenic_tail_mixture_bounds.csv`.
- Mixture grid: `results/tables/senogenic_tail_mixture_grid.csv`.
- Scenario cache: `results/cache/simulations/senogenic_tail_constraints/scenario_results.csv`.
