...
from analysis.figures.steepness_longevity import make_fig1d_new_steepness_longevity as fig1e
...
OUTPUT_INDEX = PROJECT_RESULTS_DIR / "index" / "outputs.csv"
...
def update_output_index() -> None:
    """Append generated Figure4 artifacts to the project output index."""
...
def output_index_row(
    *,
    ...
    return {
        "date": "2026-05-20",
        "task": "Figure4 country period steepness-longevity projection",
