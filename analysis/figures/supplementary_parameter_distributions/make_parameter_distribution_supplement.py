...
def build_metadata(n: int) -> dict[str, object]:
    ...
    return {
        "source_notebook": "legacy-notebook:param_distributions_investigation.ipynb",
        "n": n,
...
def update_output_index(save_pdf: bool) -> None:
    ...
    source_script = "analysis/figures/supplementary_parameter_distributions/make_parameter_distribution_supplement.py"
    input_paths = "legacy-notebook:param_distributions_investigation.ipynb"
    rows_to_add = [
        {
            "date": "2026-05-20",
            "task": TASK_NAME,
