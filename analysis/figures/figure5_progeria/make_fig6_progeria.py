...
OUTPUT_DIR = FIGURES_DIR / "Figure5_progeria"
SOURCE_DIR = RESULTS_DIR / "tables"
CACHE_DIR = RESULTS_DIR / "cache" / "simulations" / "figure5_progeria"
...
PROGERIA_DATA_PATH = RESULTS_DIR / "progeria_data.pkl"
BASELINE_FIT_PATH = (
    RESULTS_DIR
    / "fits"
    / "records"
...
def load_old_warm_starts(baseline: dict[str, float]) -> dict[tuple[str, ...], dict[str, float]]:
    path = RESULTS_DIR / "progeria_fitting_results.pkl"
    if not path.exists():
        return {}
        ...
        rows.append(
            {
                ...
                "source_script": "analysis/figures/figure5_progeria/make_fig6_progeria.py",
                "input_paths": (
