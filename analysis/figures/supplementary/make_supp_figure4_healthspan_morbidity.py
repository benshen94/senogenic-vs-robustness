...
PNG_PATH = OUTPUT_DIR / "supp_figure4_healthspan_morbidity.png"
PDF_PATH = OUTPUT_DIR / "supp_figure4_healthspan_morbidity.pdf"
...
def update_output_index() -> None:
    ...
    rows = [
        {
            "date": DATE,
            "task": "supp_figure4_healthspan_morbidity",
            ...
            "description": "PNG preview of Supplementary Fig. 4 healthspan/morbidity composite.",
        ...
        },
        {
            ...
            "source_script": str(Path(__file__).relative_to(PROJECT_ROOT)),
            "input_paths": str(survival.EVENTS_CACHE_PATH.relative_to(PROJECT_ROOT)),
            "description": "Vector PDF of Supplementary Fig. 4 healthspan/morbidity composite.",
            "notes": "Rows show schematic thresholds, age-specific state composition, and median sick span as a percentage of lifespan.",
        },
    ]
