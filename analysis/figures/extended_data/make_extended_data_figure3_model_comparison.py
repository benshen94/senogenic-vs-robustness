#!/usr/bin/env python3
"""Make Extended Data Fig. 3: Gompertz and Fedichev-Gruber model comparison.
...
OUTPUT_DIR = FIGURES_DIR / "ExtendedDataFigure3"
PNG_PATH = OUTPUT_DIR / "extended_data_figure3_model_comparison.png"
PDF_PATH = OUTPUT_DIR / "extended_data_figure3_model_comparison.pdf"

MAX_DATA_PATH = RESULTS_DIR / "tables" / "supp_model_comparison_max_lifespan.csv"
SHAPE_DATA_PATH = RESULTS_DIR / "tables" / "supp_model_comparison_shape_response.csv"

GOMPERTZ_SHAPE_PATH = RESULTS_DIR / "gamma_factor_sweep.pkl"
FEDICHEV_SHAPE_PATH = RESULTS_DIR / "fedichev_model_steepness_longevity_data.pkl"

LEGACY_NOTEBOOK = "legacy-notebook:fedichev_gompertz_models.ipynb"
OUTPUT_INDEX_PATH = RESULTS_DIR / "index" / "outputs.csv"
...
def update_output_index() -> None:
    ...
    source_script = "analysis/figures/extended_data/make_extended_data_figure3_model_comparison.py"
    input_paths = "; ".join(
        [
    ...
    new_rows = [
        {
            ...
            "task": "extended_data_figure3_model_comparison",
            "artifact_type": "figure",
            "path": str(PNG_PATH.relative_to(PROJECT_ROOT)),
            "source_script": source_script,
            "input_paths": input_paths,
            "description": "PNG preview of Extended Data Fig. 3 Gompertz and Fedichev-Gruber model comparison.",
        ...
        },
        {
            ...
            "source_script": source_script,
            "input_paths": input_paths,
            "description": "Vector PDF of Extended Data Fig. 3 Gompertz and Fedichev-Gruber model comparison.",
            "notes": "Extended Data figure output with external grouped legends.",
        },
        {
            "date": date.today().isoformat(),
            "task": "extended_data_figure3_model_comparison",
            ...
            "source_script": source_script,
            "input_paths": input_paths,
            "description": "Central maximum-lifespan source data for Extended Data Fig. 3.",
        ...
        },
        {
            ...
            "source_script": source_script,
            "input_paths": input_paths,
            "description": "Central steepness-longevity source data for Extended Data Fig. 3.",
