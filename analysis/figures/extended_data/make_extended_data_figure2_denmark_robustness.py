#!/usr/bin/env python3
"""Make Extended Data Fig. 2: Denmark historical robustness analysis."""
...
DENMARK_OUTPUT_DIR = fig4.FIGURES_DIR / "ExtendedDataFigure2"
DENMARK_SUPP_PNG = DENMARK_OUTPUT_DIR / "extended_data_figure2_denmark_robustness.png"
DENMARK_SUPP_PDF = DENMARK_OUTPUT_DIR / "extended_data_figure2_denmark_robustness.pdf"
...
def update_output_index() -> None:
    """Record Extended Data Fig. 2 artifacts in the shared output index."""
    ...
    rows = [
        fig4.output_index_row(
            ...
            notes="Used by the Denmark Extended Data Fig. 2C panel.",
        ),
        fig4.output_index_row(
            artifact_type="csv",
            ...
            source_script=source_script,
            input_paths=str(denmark_config().data_path.relative_to(PROJECT_ROOT)),
            description="Denmark Extended Data Fig. 2C fitted Makeham m estimates with 95% CIs.",
        ...
        fig4.output_index_row(
            ...
            source_script=source_script,
            input_paths=str(denmark_config().data_path.relative_to(PROJECT_ROOT)),
            description="Denmark Extended Data Fig. 2D fitted robustness estimates and CIs.",
        ...
        fig4.output_index_row(
            ...
            source_script=source_script,
            input_paths=str(denmark_config().data_path.relative_to(PROJECT_ROOT)),
            description="Extended Data Fig. 2 Denmark robustness PNG.",
        ...
        fig4.output_index_row(
            ...
            source_script=source_script,
            input_paths=str(denmark_config().data_path.relative_to(PROJECT_ROOT)),
            description="Extended Data Fig. 2 Denmark robustness vector PDF.",
            notes="Panels A/B use Fig1E baseline from age 20; panel C uses fitted Makeham m; panel D shows Xc through 2020.",
        ),
    ]
...
def main() -> None:
    DENMARK_OUTPUT_DIR.mkdir(parents=True, exist_ok=True)
    ...
    print(f"Saved Extended Data Fig. 2 PNG: {DENMARK_SUPP_PNG}")
    print(f"Saved Extended Data Fig. 2 PDF: {DENMARK_SUPP_PDF}")
