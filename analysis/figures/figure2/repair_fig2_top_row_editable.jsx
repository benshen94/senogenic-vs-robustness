// Replace top-row placed PDF panels in Figure2.pdf with editable vector/text objects.
...
(function () {
    ...
    var root = File($.fileName).parent.parent.parent.parent.fsName;
    var outputDir = root + "/Figures/Figure2";
    var targetPath = outputDir + "/Figure2.pdf";
    var panels = [
