...
CACHE_DIR = RESULTS_DIR / "cache" / "simulations" / "figure2"
...
PLOT_DATA_PATH = RESULTS_DIR / "tables" / "fig2a_new_conditional_survival.csv"
CI_ENVELOPE_PATH = RESULTS_DIR / "tables" / "fig2a_new_fit_ci_envelopes.csv"
LEGACY_OUTPUT_PATHS = {
    ...
    rows = [
        {
            ...
            "path": "Figures/Figure2/fig2a_new.png",
            "source_script": "analysis/figures/figure2/make_fig2a_new.py",
            "input_paths": "results/fits/records/joint2019_tail90_sweden_emphasis.json; results/fits/ci/joint2019_tail90_sweden_emphasis_ci.csv",
        ...
        },
        {
            ...
            "task": "fig2a_new_survival_tail",
            "artifact_type": "figure",
            "path": "Figures/Figure2/fig2a_new.pdf",
            "source_script": "analysis/figures/figure2/make_fig2a_new.py",
            "input_paths": "results/fits/records/joint2019_tail90_sweden_emphasis.json; results/fits/ci/joint2019_tail90_sweden_emphasis_ci.csv",
        ...
        },
        {
            ...
            "task": "fig2a_new_survival_tail",
            "artifact_type": "csv",
            "path": "results/tables/fig2a_new_conditional_survival.csv",
            "source_script": "analysis/figures/figure2/make_fig2a_new.py",
        ...
        },
        {
            ...
            "task": "fig2a_new_survival_tail",
            "artifact_type": "csv",
            "path": "results/tables/fig2a_new_fit_ci_envelopes.csv",
            "source_script": "analysis/figures/figure2/make_fig2a_new.py",
            "input_paths": "results/fits/ci/joint2019_tail90_sweden_emphasis_ci.csv",
