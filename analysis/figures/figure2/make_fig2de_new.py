...
CENTRAL_DATA_PATH = RESULTS_DIR / "tables" / "fig2de_new_mortality_curves.csv"
ENVELOPE_DATA_PATH = RESULTS_DIR / "tables" / "fig2de_new_fit_ci_envelopes.csv"
RAW_DIGITIZED_DATA_PATH = RESULTS_DIR / "tables" / "fig2d_raw_digitized_points.csv"
    ...
    rows = [
        {
            ...
            "source_script": "analysis/figures/figure2/make_fig2de_new.py",
        ...
        },
        {
            ...
            "source_script": "analysis/figures/figure2/make_fig2de_new.py",
            "input_paths": "results/cache/simulations/figure2/fig2de_new_plot_records.pkl",
