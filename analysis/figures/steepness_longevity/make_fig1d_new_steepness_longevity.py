#!/usr/bin/env python3
"""Make the new Fig1D steepness-longevity response plane."""
...
RUN_DIR = RESULTS_DIR / "steepness_longevity_sweden2019_sensitivity"
METRICS_PATH = RUN_DIR / "metrics_long.csv"
PLOT_DATA_PATH = RUN_DIR / "fig1d_new_steepness_longevity_plot_data.csv"
SUMMARY_PATH = RUN_DIR / "fig1d_new_steepness_longevity_point_intervals.csv"
ENVELOPE_PATH = RUN_DIR / "fig1d_new_steepness_longevity_shaded_envelopes.csv"

OUTPUT_DIR = FIGURES_DIR / "Figure1"
PNG_PATH = OUTPUT_DIR / "fig1d_new_steepness_longevity.png"
PDF_PATH = OUTPUT_DIR / "fig1d_new_steepness_longevity.pdf"
PANEL_F_PNG_PATH = OUTPUT_DIR / "fig1_panel_f_steepness_longevity.png"
PANEL_F_PDF_PATH = OUTPUT_DIR / "fig1_panel_f_steepness_longevity.pdf"
...
def main() -> None:
    ...
    fig.savefig(PANEL_F_PNG_PATH, dpi=350, bbox_inches="tight")
    fig.savefig(PANEL_F_PDF_PATH, bbox_inches="tight")
    plt.close(fig)

    print(f"Saved PNG: {PNG_PATH}")
    print(f"Saved PDF: {PDF_PATH}")
    print(f"Saved panel F PNG: {PANEL_F_PNG_PATH}")
    print(f"Saved panel F PDF: {PANEL_F_PDF_PATH}")
