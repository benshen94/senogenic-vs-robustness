...
65-100. Hazard residuals were computed on the log scale:
...
The numeric CI table is saved at `saved_results/joint_shared_eta_beta_epsilon_65_100_n100k_tail90_fit_2019_ci.csv`.
