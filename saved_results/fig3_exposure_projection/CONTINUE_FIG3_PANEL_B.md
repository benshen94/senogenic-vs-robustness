...
- A backup of the pre-replacement PDF was saved at:
  `saved_results/fig3_exposure_projection/fig3_exposure_projection_before_panel_b_update.pdf`
...
- Baseline scenarios are central USAFIT plus one-at-a-time endpoints for `Xc` and `xc_std_frac`, loaded from:
  `saved_results/fit_archive/ci/hybrid2019_swe_tail90_usa_refit_ci.csv`
